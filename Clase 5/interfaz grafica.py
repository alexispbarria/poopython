...
class formularioArticulos:
    def __init__(self):
        ...
        self.ventana1= tk.Tk()
        self.ventana1.title("mantenimiento de articulos") # darle titulo a una ventana 
        self.cuaderno1 = ttk.Notebook(self.ventana1)
        self.cargar_articulos()
        self.consulta_por_codigo()
        self.listado_completo()
        self.cuaderno1.grid(column=0, row=0, padx=10, pady=10) #estetico
    ...
    def cargar_articulos (self):
        ...
        self.label1.grid(column=0, row=0, padx=5, pady=4)
    ...
    def agregar(self):
        datos=(self.descripcioncarga.get(), self.preciocarga.get()) #metodos get permiten consultar "algo"
    ...
    def consultar(self):
        ...
        if len(respuesta)>0:
            ...
            self.precio.set('')
            mb.showinfo("información", "No existe un articulo con dicho codigo")
